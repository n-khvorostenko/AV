<?
$MESS["AV_AUTH_RECAPTCHA_FAILED"]             = 'Сервис "Я не робот" не пройден. Попробуйте еще раз!';
$MESS["AV_AUTH_REGISTRATION_FIELD_REQUIRED"]  = 'Поле #FIELD_NAME# обязательно для заполнения';
$MESS["AV_AUTH_REGISTRATION_SESSION_EXPIRED"] = 'Ваша сессия истекла, повторите попытку регистрации.';
$MESS["AV_AUTH_REGISTRATION_DECODE_ERROR"]    = 'Ошибка при дешифровании пароля (#ERRCODE#).';
// auth fields titles
$MESS["AUTH_FIELD_LOGIN"]    = 'Логин';
