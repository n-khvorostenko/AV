...
$APPLICATION->SetPageProperty("title", "Электроды ► купить сварочные электроды в Украине: Днепр, Киев, Харьков, Львов, Одесса, опт, розница | Направление АВ металл групп ™ avmg.com.ua");
