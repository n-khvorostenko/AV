...
<?if($arParams["BUTTON_TYPE"] == 'button' && $arParams["NAME"]):?>
	<button
		class="av-form-elements-av_site_alt-button"
		name="<?=$arParams["NAME"]?>"
...
<?if($arParams["BUTTON_TYPE"] == 'label'):?>
	<span class="av-form-elements-av_site_alt-button" <?=$arParams["ATTR"]?>>
	<?=$arParams["TITLE"]?>
</span>
<?endif?>
<?
...
<?if($arParams["BUTTON_TYPE"] == 'link' && $arParams["LINK"]):?>
	<a class="av-form-elements-av_site_alt-button" href="<?=$arParams["LINK"]?>" <?=$arParams["ATTR"]?>>
		<?=$arParams["TITLE"]?>
	</a>
<?endif?>
<?
